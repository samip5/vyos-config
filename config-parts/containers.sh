...
set container name librenms image 'librenms/librenms:24.3.0'
...
set container name librenms-db image 'mariadb:10.11'
...
set container name librenms-dispatcher image 'librenms/librenms:24.3.0'
...
set container name unifi host-name 'unifi'
