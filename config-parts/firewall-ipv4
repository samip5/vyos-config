...
handle_traffic to containers from guest iot lan trusted wan local
end_traffic    to containers

begin_traffic  to guest
handle_traffic to guest from containers iot lan trusted wan local
end_traffic    to guest

begin_traffic  to iot
handle_traffic to iot from containers guest lan trusted video wan local
end_traffic    to iot

begin_traffic  to lan
handle_traffic to lan from containers guest iot trusted wan local
end_traffic    to lan

begin_traffic  to trusted
handle_traffic to trusted from containers guest iot lan wan local
end_traffic    to trusted

begin_traffic  to wan
handle_traffic to wan from containers guest iot lan trusted local
end_traffic    to wan

begin_traffic  to local
handle_traffic to local from containers guest iot lan trusted wan
...
set firewall ipv4 name iot-servers rule 210 action 'accept'
...
set firewall ipv4 name local-trusted rule 300 description 'Rule: accept_wireguard'
set firewall ipv4 name local-trusted rule 300 source port '51820'
...
# set firewall ipv4 name trusted-local rule 300 description 'Rule: accept_discovery_from_sonos_players'
# set firewall ipv4 name trusted-local rule 300 destination port '1900,1901,1902'
# set firewall ipv4 name trusted-local rule 300 protocol 'udp'
# set firewall ipv4 name trusted-local rule 300 source group address-group 'sonos_players'

set firewall ipv4 name trusted-local rule 310 action 'accept'
set firewall ipv4 name trusted-local rule 310 description 'Rule: accept_discovery_from_sonos_controllers'
set firewall ipv4 name trusted-local rule 310 destination port '1900,1901,1902,57621'
set firewall ipv4 name trusted-local rule 310 protocol 'udp'
set firewall ipv4 name trusted-local rule 310 source group address-group 'sonos_controllers'
